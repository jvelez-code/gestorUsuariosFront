...
import { ExcelSecretariaVirtualService } from 'src/app/_serviceRepo/excel.secretaria.virtual.service';
...
export class SecretariaVirtualComponentRepo implements OnInit {
