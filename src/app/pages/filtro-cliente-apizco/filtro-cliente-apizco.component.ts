...
@Component({
  selector: 'app-filtro-cliente-apizco',
  standalone: true,
  imports: [],
  templateUrl: './filtro-cliente-apizco.component.html',
  styleUrl: './filtro-cliente-apizco.component.scss'
})
export class FiltroClienteApizcoComponentimplements implements OnInit, OnDestroy {
